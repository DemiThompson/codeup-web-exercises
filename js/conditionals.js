 ...
 function analyzeColor(color) {
    ...
    switch(lowerColor) {
        ...
        case "green":
            ...
            break;
        case "orange":
            message = "Granges are Orange"
            break;
        case "yellow":
            message = "bannas are Yellow"
            break;
        case "indigo":
            message = "Plums are Indigo"
            break;
        case "violet":
...
let totalbill = parseInt(prompt("What is your total"));
alert("Your lucky number is " + luckyNumber + ". Intial price was $" + totalbill + ". \nYour final price is $" + calculateTotal(luckyNumber,totalbill));
 ...
 */
let confirmRespone = confirm("Would you like to enter a number?");
if(confirmRespone) {
    ...
    if (!isNaN(parseInt(userNumber))) {
        ...
        alert("your number was " + userNumber + " your new  number  is " + (parseInt(userNumber )+ 100));
        if (userNumber >= 0) {
